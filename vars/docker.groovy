        ...
        stages {
            ...
            stage('Docker Build') {
                steps {
                  ...
                  docker tag 975050272810.dkr.ecr.us-east-1.amazonaws.com/${params.COMPONENT}:${GIT_BRANCH} 975050272810.dkr.ecr.us-east-1.amazonaws.com/${params.COMPONENT}:latest
